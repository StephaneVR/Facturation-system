...
namespace Facturation.WEB.UI
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
//            string username = "systeemfacturen@gmail.com";
//            string password = "SysteemFacturen123";
...
//            return client.SendMailAsync(username, message.Destination, message.Subject, message.Body);
            ...
            return smtpobj.SendMailAsync("systeemfacturen@gmail.com", message.Destination, message.Subject, message.Body);
        }
    }
